...
- repo: codex-plugin-cc - source: https://github.com/openai/codex-plugin-cc.git - latest synced commit: 6a5c2ba53b73 - summary: Use Codex from inside Claude Code for code reviews or to delegate tasks to Codex.
